...
export const EditNotePage = ({ updateNote }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className='mb-3'>
        ...
        <input className='form-control' id='exampleFormControlInput1' placeholder="Enter note's title" value={title} onChange={(e) => setTitle(e.target.value)} />
      </div>
